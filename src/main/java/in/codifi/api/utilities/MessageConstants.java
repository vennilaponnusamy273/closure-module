...
public class MessageConstants {
	...
	public static final String POSITIONS_EXIST = "Positions Exits. Can't close the account. Please close the positions and try again.";
	
	public static final String HOLDINGS_EXIST = "Holdings exits, please upload CMR Copy to procesed further";
	public static final String FUND_AVAILABLE = "Funds available please withdraw/ deposit to make funds zero and try again";
	public static final String CMR_AVAILABLE = "CMR Copy Available, processed further";
